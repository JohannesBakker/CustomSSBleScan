...
import systems.kestrel.bluetooth_le.services.Bluetooth.Ble.BlePeripheralDelegate;
...
public class BlePeripheral {
    ...
    public BlePeripheral(Context context, String address, int rssi, byte[] scanRecord) {
        ...
        this.timeoutRunnable = new Runnable() {
            ...
            public void run() {
                if (connectionState() != STATE_CONNECTED) {
                    Logger.e(TAG, "BlePeripheral timoutRunnable - disconnect()");
                    disconnect();
                    timeoutHandler.removeCallbacks(timeoutDisconnectRunnable);
                    if (delegate != null) {
                        delegate.gattDisconnected(BlePeripheral.this);
        ...
        if (mBluetoothAdapter == null) {
            Logger.e(TAG, "BlePeripheral(%s) - blemanager.bluetoothadapter is null", address);
            return;
        }
